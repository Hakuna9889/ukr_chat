...
using static UkrChatSupport.Sys.Constants;
...
public class KeyboardHook : IDisposable
{
    ...
    public static extern int SendMessage(nint hWnd, int wMsg, int wParam, int lParam);
    ...
    private static extern nint SetWindowsHookEx(
        HookType idHook, CallbackDelegate lpfn, nint hInstance,
        int threadId);
    ...
    [DllImport("user32.dll")]
    public static extern uint GetWindowThreadProcessId(nint hwnd, nint proccess);
